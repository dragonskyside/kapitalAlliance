    ...
    <div className="flex justify-between font-mono p-20 w-full h-screen bg-webphoto bg-cover bg-center">
        ...
        <div className=" w-1/2 text-2xl text-white align center font-bold ml-48">
            ...
            <div className="">
                ...
                <p className='text-sm mb-8'>Proceeds from the NFT launch will be gathered up in ethereum and used to seed the treasury. Community NFT holders will be issued KA governance tokens via airdrop.
                </p>
            </div>
            <div className="">
