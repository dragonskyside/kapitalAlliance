...
function Nft() {
  return (
    <div id="nft" className="flex justify-between font-mono p-20 w-full h-screen bg-cover bold bg-center overflow-auto" cursor-pointer >
      
       {/* <div className="">
       <img src="images/midas.webp" h-90 w-75 alt="NFT" className='w-48 m-4 py-24'></img></div> */}

        {/* Left side */}
        <div className="w-1/2 text-xl text-black align-center">
            ...
            <a href="#"><button class="hover:bg-amber-200 text-black font-bold py-4 px-4 rounded mb-16 hover:scale-110">Apply to WhiteList</button></a>
